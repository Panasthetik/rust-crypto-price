...
#[derive(Parser, Debug)]
#[clap(author, version="0.1.0", about="Crypto Price  - Command Line Interface (CLI) Application")]
struct Cli {
    ...
    durrency: String,
    #[clap(short, long, default_value = "SOL")]
    gurrency: String,
...
pub fn crypto_publisher(){
    ...
    loop {
        ...
        let currency2 = &args.durrency;
        let currency3 = &args.gurrency;
        ...
        let spot_price2 = get_coin_price("spot".to_string(), currency2.to_string(), rates.to_string());
        let buy_price2 = get_coin_price("buy".to_string(), currency2.to_string(), rates.to_string());
        let sell_price2 = get_coin_price("sell".to_string(), currency2.to_string(), rates.to_string());

        let spot_price3 = get_coin_price("spot".to_string(), currency3.to_string(), rates.to_string());
        let buy_price3 = get_coin_price("buy".to_string(), currency3.to_string(), rates.to_string());
        let sell_price3 = get_coin_price("sell".to_string(), currency3.to_string(), rates.to_string());
        ...
        let spread_price2: f32 = (buy_price2.unwrap().parse::<f32>().unwrap()) - (&sell_price2.unwrap().parse::<f32>().unwrap());
        let spread_price3: f32 = (buy_price3.unwrap().parse::<f32>().unwrap()) - (&sell_price3.unwrap().parse::<f32>().unwrap());
        ...
        println!("{}: {}-{} SPOT Price: {} | BUY Price: {} | SELL Price: {} | Price Spread: {}", quote_time2.unwrap(), currency2.to_string(), rates.to_string(), spot_price2.unwrap(), buy_price2.unwrap(), sell_price2.unwrap(), spread_price2.to_string());
        println!("{}: {}-{} SPOT Price: {} | BUY Price: {} | SELL Price: {} | Price Spread: {}", quote_time3.unwrap(), currency3.to_string(), rates.to_string(), spot_price3.unwrap(), buy_price3.unwrap(), sell_price3.unwrap(), spread_price3.to_string());
